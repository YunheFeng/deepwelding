...
parser.add_argument('--dataset', default='t_6_s_2_c_120_train5', type=str)
...
def main(args):
	...
	with open('../../data/image_selector_data/labels/' + args.dataset + '_' + args.data_type + '_label.csv') as f:
		frames_labels = [(line.strip().split(',')[0], line.strip().split(',')[1]) for line in f]

	# re-organize data by labels
	file_dir = '../../data/image_selector_data/' + args.dataset + '/' + args.data_type + '/'
	file_format = '.jpeg'
